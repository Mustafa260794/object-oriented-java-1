...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		//map1-in olcusu 350 oldugundan ve 50 x-i oldugundan ustune 350 gelib 20-de bos yer verdim
		map2 = new UnfoldingMap(this, 420, 50, 350, 500, provider);
		
		//Bakida is yerimin ardessini verecem
		map2.zoomAndPanTo(16, new Location(40.40f, 49.86f));
